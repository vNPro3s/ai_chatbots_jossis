...
Let us try this. Open a notebook [prompt_design_1.iynb](../notebooks/prompt_design/propt_design_1.ipynb), and download `helper functions` in [aux_functions.py](../notebooks/prompt_design/aux_functions.py). Put it under the same folder in the helper_funk/info.txtVSC project folder. 
