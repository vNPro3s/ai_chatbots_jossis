...
Let us try this. Open a notebook [prompt_design_1.iynb](../notebooks/prompt_design/prompt_design_1.ipynb), and download `helper functions` in [aux_functions.py](../notebooks/prompt_design/aux_functions.py). Put it under the same folder in the helper_funk/info.txtVSC project folder. 
...
Many tasks can be resolved with efficient, prompt design. Here are just a few:
 ...
 - Performing inference [inference notebook](../notebooks/prompt_design/inferencing.ipynb)
 - Performing transformation [trensformation notebook](../notebooks/prompt_design/transformation.ipynb)
 - Expanding the response [explanding notebook](../notebooks/prompt_design/expanding.ipynb)
